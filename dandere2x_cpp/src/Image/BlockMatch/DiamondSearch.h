...
#ifndef DIAMONDSEARCH_H
#define DIAMONDSEARCH_H
...
public:
    ...
    // Diamond search but a greater jump radius. 
...
//                if (!flagArray[i]) {
//                    
//                    sum = CImageUtils::variance(imageA, imageB, initialX, initialY, pointArray[i].x, pointArray[i].y,
//                            boxSize);
//                    
