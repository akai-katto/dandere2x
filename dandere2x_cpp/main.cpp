...
void testing_files(){
    ...
    shared_ptr<Frame> f1 = make_shared<Frame>("C:\\Users\\tylerpc\\Desktop\\3.6\\workspace\\gui\\subworkspace\\inputs\\frame19.png");
    shared_ptr<Frame> f2 = make_shared<Frame>("C:\\Users\\tylerpc\\Desktop\\3.6\\workspace\\gui\\subworkspace\\inputs\\frame20.png");
    shared_ptr<Frame> f2_compressed = make_shared<Frame>("C:\\Users\\tylerpc\\Desktop\\3.6\\workspace\\gui\\subworkspace\\inputs\\frame20.png",100);

    PredictiveFrameDynamicBlockSize test = PredictiveFrameDynamicBlockSize(eval, blockMatch, f1, f2, f2_compressed, 1);
    test.best_predictive_frame();
