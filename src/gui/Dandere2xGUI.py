...
class Ui_Dandere2xGUI(object):
    ...
    def retranslateUi(self, Dandere2xGUI):
        ...
        self.image_quality_box.setItemText(0, _translate("Dandere2xGUI", "99"))
        self.image_quality_box.setItemText(1, _translate("Dandere2xGUI", "98"))
        self.image_quality_box.setItemText(2, _translate("Dandere2xGUI", "97"))
        self.image_quality_box.setItemText(3, _translate("Dandere2xGUI", "96"))
        self.image_quality_box.setItemText(4, _translate("Dandere2xGUI", "95"))
        self.image_quality_box.setItemText(5, _translate("Dandere2xGUI", "90"))
        self.image_quality_box.setItemText(6, _translate("Dandere2xGUI", "85"))
        self.image_quality_box.setItemText(7, _translate("Dandere2xGUI", "80"))
        self.image_quality_box.setItemText(8, _translate("Dandere2xGUI", "75"))
        self.image_quality_box.setItemText(9, _translate("Dandere2xGUI", "70"))
